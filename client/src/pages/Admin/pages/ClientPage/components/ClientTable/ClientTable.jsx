...
function ClientTable() {
  const clients = [
    { id: 1, name: "John Smith", email: "js@info.com", phone: ["1234567890", "0987654321"] },
    { id: 2, name: "Jennifer Lee", email: "jenny@info.com", phone: ["1234567890", "0987654321"] },
    { id: 3, name: "Alex Jean", email: "alex@info.com", phone: ["1234567890", "0987654321"] }
  ];

  return (
    <div className="w-full overflow-x-auto bg-gray-100 p-4">
      <table className="min-w-full divide-y divide-gray-300 shadow-md bg-white rounded-md overflow-hidden">
