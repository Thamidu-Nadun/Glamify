...
function About () {
  return (
    <div className="flex h-fit w-screen items-center justify-center p-[2rem] bg-white">
      <div className="py-5 bg-[#f8dbfe] w-full h-full rounded-2xl flex flex-col lg:flex-row items-center lg:justify-start gap-5">
        <div className="box-action w-[50%] flex flex-col justify-center items-center pl-[2rem] pr-[2rem] lg:items-start gap-2">
        <div className="text-center lg:text-start">
          ...
          <p className='text-lg font-normal text-black/50 text-center lg:text-start'>
